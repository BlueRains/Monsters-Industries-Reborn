...
# Multiply actual coordinates by 2 for this number
scoreboard players set #middle.x temp 281
scoreboard players set #middle.z temp -500
...
setblock 132 20 -92 birch_wall_sign[facing=west]{Color:"black",Text2:'{"text":"Mob Swap","clickEvent":{"action":"run_command","value":"tellraw @s [\\"\\",{\\"text\\":\\"Mob Swap\\",\\"color\\":\\"gold\\"},{\\"text\\":\\" - \\",\\"color\\":\\"dark_gray\\"},{\\"text\\":\\"Swaps the position of all hostile mobs to the other teams\' side.\\",\\"color\\":\\"yellow\\"}]"}}',Text3:'{"text":"175 Stock"}'} destroy
...
setblock 148 20 -162 spruce_wall_sign[facing=east]{Color:"black",Text2:'{"text":"Mob Swap","clickEvent":{"action":"run_command","value":"tellraw @s [\\"\\",{\\"text\\":\\"Mob Swap\\",\\"color\\":\\"gold\\"},{\\"text\\":\\" - \\",\\"color\\":\\"dark_gray\\"},{\\"text\\":\\"Swaps the position of all hostile mobs to the other teams\' side.\\",\\"color\\":\\"yellow\\"}]"}}',Text3:'{"text":"175 Stock"}'} destroy
